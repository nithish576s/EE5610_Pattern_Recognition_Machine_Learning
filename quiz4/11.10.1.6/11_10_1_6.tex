...
\end{bmatrix}
\\
	\brak{\myvec{B}-\myvec{A}}^{\top} \brak{\myvec{A}-\myvec{C}} &= 
\begin{bmatrix}
-1 \hspace{0.2cm} 1
\end{bmatrix}
*
...
$\brak{\myvec{A}-\myvec{B}}^{\top} \brak{\myvec{A}-\myvec{C}} = 0 \Rightarrow$ angle between $\myvec{A}-\myvec{B}$ and $\myvec{B}-\myvec{C}$ is 90 degrees.
