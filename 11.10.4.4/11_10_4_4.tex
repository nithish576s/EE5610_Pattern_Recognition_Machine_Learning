...
%\end{figure}
		...
		Let the required point on y axis be $(0,y)$, then the distance of this point from the given line is,   
		\begin{align}
			d &= \frac{\abs{0+3y-12}}{\sqrt{3^2+4^2}}\\
			d &= \frac{\abs{3y-12}}{5}\\
...
The foot of perpendicular to the line from the point $(0,\frac{32}{3})$ is,
		...
		\begin{align}
			\vec{x}_0 = \min_{\vec{x}} \norm{\vec{x}-\myvec{0\\\frac{32}{3}}}\\
			\text{s.t} \quad \myvec{4 & 3}\vec{x} = 12
		\end{align}

Solving the above optimization with cvxpy gives,
		
\begin{align}
	\vec{x}_0 = \myvec{-3.2\\8.2667}
\end{align}

The foot of perpendicular to the line from the point $(0,-\frac{8}{3})$ is,
		\begin{align}
			\vec{x}_0 = \min_{\vec{x}} \norm{\vec{x}-\myvec{0\\-\frac{8}{3}}}\\
			\text{s.t} \quad \myvec{4 & 3}\vec{x} = 12
		\end{align}
...
\begin{align}
	\vec{x}_0 = \myvec{3.2\\-0.2667}
\end{align}
%		\begin{table}[h]
%			\centering
%			\input{table/9_10_6_4_table.tex}
%			\caption{}
%			\label{tab:1}
%		\end{table}
